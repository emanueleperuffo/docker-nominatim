...
$minimal_apt_get_install \
	...
	php5 php-pear php5-pgsql php5-json php-db \
...
## Compiling Nominatim
gosu nominatim /home/nominatim/Nominatim-${NOMINATIM_VERSION}/configure
gosu nominatim make -C /home/nominatim/Nominatim-${NOMINATIM_VERSION
